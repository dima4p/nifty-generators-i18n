...
This is a fork of http://github.com/ryanb/nifty-generators/ for the purpose to internationalize it and fix some things I do not like, in particular use of mocha.
...
Make sure you're using Rails 2.1 or greater.
...
http://github.com/dima4p/nifty-generators/issues
